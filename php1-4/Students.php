    ...
    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">remplir la form</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
                <div class="modal-body">
                    <form action="Students.php"  method ="POST" id="form">
                        <div class="">
                        ...
                        <div class="modal-footer">
                            <input class="btn bg-info rounded-3 w-100 text-white mt-3" name="submit" type="submit">
                        </div>
                    </form>
                </div>   
            </div>
    ...
    <?php
        ...
        if (isset($_POST['submit'])) {
            if (!empty($_POST['name']) && !empty($_POST['email']) && !empty($_POST['phone']) && !empty($_POST['enroll_number']) && !empty($_POST['date_of_admission'])) {
                ...
                $requet = "INSERT INTO students VALUES ('','$nom','$email', '$phone', '$enroll', '$date')";
                        ...
                        <div class="row mt-4">
                            <div class="col-12 d-flex justify-content-between">
                                ...
                                <div class="">
                                    ...
                                    <label for="adds" class="btn btn-info text-white" data-bs-toggle="modal" data-bs-target="#staticBackdrop">ADD NEW STUDENT</label>
                                </div>
                            </div>
                           <!--start ajouter-->
                                ...
                                <?php
                                        ...
                                        while($students = mysqli_fetch_assoc($query)){
                                            ...
                                            <td><img src="images/table.svg"></td>
                                                    ...
                                                    <a href="?id='.$id.'" onclick="return delet()"><i class="bi bi-trash text-info"></i></a></td>
                                                  </tr>';
                                                        }    
