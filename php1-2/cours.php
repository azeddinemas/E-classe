<?php
 ...
 if (isset($_POST['id'])) {
    ...
    $query=mysqli_query($con,$sql);
        ...
        if (!empty($_POST['langage']) && !empty($_POST['prix']) && !empty( $_POST['duree'])) {
                           ...
                           <!--start ajouter-->
                            ...
                            <div class="form">
                                <form action="cours.php" class="mt-4 d-flex justify-content-between" method ="POST" id="form">
                                    ...
                                    <input class="bg-info border-0 rounded-pill text-white mt-3" type="submit">
                                    ...
                                    <?php
                                            ...
                                            while($cours = mysqli_fetch_assoc($query)){
                                                ...
                                                echo '<tr style="border-top: 10px solid #f8f9fa;" class="bg-white align-middle">
                                                        ...
                                                        <a href="?id='.$id.'&delete=1"><i class="bi bi-trash text-info"></i></a></td>
                                                    </tr>';
