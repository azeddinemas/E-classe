        ...
        <div class="row">
            ...
            <div style="background: #FAFFC1;" id="toggel" class="col-lg-2 col-md-3 col-sm-6  text-center">
                ...
                <nav class="text-start p-3">
                    <a href="index.php" class="nav-link text-black text-nowrap  <?php if(basename($_SERVER["REQUEST_URI"]) == "index.php") echo 'bg-info rounded-pill'; ?>">
                    ...
                    <br>
                    <a class="nav-link text-black text-nowrap  <?php if(basename($_SERVER["REQUEST_URI"]) == "Students.php") echo 'bg-info rounded-pill'; ?>" href="Students.php">
                        <img class="me-3" src="images/student.svg" alt=""> Students
                    </a>
                    <br>
                    <a class="nav-link text-black text-nowrap  <?php if(basename($_SERVER["REQUEST_URI"]) == "payment.php") echo 'bg-info rounded-pill'; ?>" href="payment.php">
